...
describe.skip('Accordion', () => {
  it('auto match snapshot', () => {
    const Wrapper = (props) => (
      <Accordion accordion>
        <Accordion.Panel header="SECTION 1">module 1</Accordion.Panel>
        <Accordion.Panel header="SECTION 2">module 2</Accordion.Panel>
        <Accordion.Panel header="SECTION 3">module 3</Accordion.Panel>
      </Accordion>
    );
  ...
  it('Accordion accordion control active key', () => {
    ...
    AccordionActiveKey.find(Collapse.ItemHeader).at(2).simulate('click');
