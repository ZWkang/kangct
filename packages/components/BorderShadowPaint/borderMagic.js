...
import transfromData from '../helper/utils.js'
 ...
 */
const calcBorderStyle = (matrixArray = [], normalSize = 10) => matrixArray.map(v => `${v[0]*normalSize}px ${v[1]*normalSize}px ${v[2]}`)
